...
use CoreDomain\Objects\LightDesign as BaseLightDesign;

/**
 * LightDesign
 *
 * @ORM\Table(name="light_design")
 * @ORM\Entity(repositoryClass="CoreBundle\Repository\LightDesignRepository")
 */
class LightDesign extends BaseLightDesign
{
    /**
     * @var int
     *
