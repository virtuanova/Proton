...
use CoreDomain\Objects\OtherStudy as BaseOtherStudy;

/**
 * OtherStudy
 *
 * @ORM\Table(name="other_study")
 * @ORM\Entity(repositoryClass="CoreBundle\Repository\OtherStudyRepository")
 */
class OtherStudy extends BaseOtherStudy
{
    /**
     * @var int
     *
