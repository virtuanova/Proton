...
use CoreDomain\Objects\EditedBook as BaseEditedBook;
/**
 * EditedBook
 *
 * @ORM\Table(name="edited_book")
 * @ORM\Entity(repositoryClass="CoreBundle\Repository\EditedBookRepository")
 */
class EditedBook extends BaseEditedBook
{
    /**
     * @var int
     *
     ...
     * @var string
     *
     * @ORM\Column(name="editing_role", type="string", length=255, nullable=true, unique=false)
     */
