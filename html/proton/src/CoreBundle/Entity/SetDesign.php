...
use CoreDomain\Objects\SetDesign as BaseSetDesign;
/**
 * SetDesign
 *
 * @ORM\Table(name="set_design")
 * @ORM\Entity(repositoryClass="CoreBundle\Repository\SetDesignRepository")
 */
class SetDesign extends BaseSetDesign
{
    /**
     * @var int
     *
